...
export default function Analytics() {
  ...
  const { teamMetrics, records } = data;
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-gray-500 dark:text-gray-400 uppercase bg-gray-50 dark:bg-gray-800/50">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-center">PF <span className="text-[10px] lowercase text-gray-400 font-normal ml-1">(Points For)</span></th>
                <th className="px-4 py-3 font-semibold text-center">PA <span className="text-[10px] lowercase text-gray-400 font-normal ml-1">(Points Against)</span></th>
                <th className="px-4 py-3 font-semibold text-center">Point Diff</th>
              </tr>
            </thead>
            <tbody>
